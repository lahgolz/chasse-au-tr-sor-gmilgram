...
const navigationMenuTriggerStyle = cva(
	'group inline-flex h-10 w-max items-center justify-center rounded-md text-foreground/60 px-4 py-2 text-sm font-medium transition-colors hover:text-foreground/80 focus:text-foreground/80 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:text-foreground data-[state=open]:text-foreground',
);
...
>(({ href, ...props }, ref) => {
	...
	return <NavigationMenuPrimitive.Link ref={ref} href={href} active={pathname === href} {...props} />;
});
